...
# screen timers:
#     timer 0.05 repeat True action If(timers > 0, SetVariable('timers', timers-0.05), Jump(marker))
#     bar value timers range time_range xalign .5 xmaximum 300 
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc") and main_menu:
            ...
            textbutton _("Выход") action Quit(confirm=main_menu)
...
screen main_menu():
    ...
    vbox:
        ...
        xalign 0.05
        yalign 0.5
        text "{size=+50}Magical Tales{/size}}"
